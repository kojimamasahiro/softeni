  ...
  return (
    <>
      ...
      <PageLayout>
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Q. 個別の選手ページがある選手とない選手がいるのはなぜですか？</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Q. 自分の情報を掲載しないでほしいのですが。</h2>
          <p>お問い合わせフォームよりご連絡ください。掲載の停止・削除に対応します。</p>
        </section>
      </PageLayout>
    </>
  );
