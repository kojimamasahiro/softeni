...
export default function PrimarySchoolPrefecturePage({ prefecture, teams, threshold }: Props) {
  ...
  return (
    <>
      <MetaHead
        ...
        description={`${prefecture.name}の小学生ソフトテニス。全日本小学生選手権大会に出場した${teams.length}団体の戦績と、小学生から中学への進路をまとめています。`}
        url={pageUrl}
        type="website"
      />
      <Head>
...
export const getStaticProps: GetStaticProps<Props> = async (context) => {
  ...
  return { props: { prefecture, teams: getTeamsByPrefecture(prefectureId), threshold: getThreshold() } };
};
