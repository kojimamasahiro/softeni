  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.results}>
        ...
        <Link href="/players/hirooka-sora/results" className={styles.link}>
          詳細を見る
        </Link>
      </section>
      ...
      <section className={styles.links}>
        ...
        <ul className={styles.link}>
          <li className={styles.item}>
            <Link href="https://www.instagram.com/solananoyo0602/" target="_blank" rel="noopener noreferrer">Instagram</Link>
          </li>
        </ul>
      </section>
    </div>
