...
const MatchDetail = () => {
  ...
  return (
    <div className="mx-auto max-w-6xl p-4 md:p-6">
      ...
      <div className="grid gap-6 md:grid-cols-[420px_1fr] md:items-start">
        <section className="md:sticky md:top-4 z-20">
              ...
              {selectedPointMeta ? (
                <div className="flex flex-wrap items-center gap-2 text-sm">
                  ...
                  {selectedPointMeta.point.video_end_ms != null && (
                    <span className="rounded-full bg-slate-100 px-3 py-1 text-slate-700">
                      終了 {formatVideoTimestamp(selectedPointMeta.point.video_end_ms)}
                    </span>
                  )}
