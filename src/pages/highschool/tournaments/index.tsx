...
export default function HighschoolTournamentsIndex({ tournaments }: Props) {
  ...
  return (
    <>
      <MetaHead
        title="高校ソフトテニス 全国大会の歴代記録（インターハイ・ハイジャパ・高校選抜） | Softeni Pick"
        description="高校ソフトテニスの代表的な全国大会（インターハイ＝全国高等学校総合体育大会、ハイスクールジャパンカップ＝通称「ハイジャパ」、全日本高等学校選抜＝高校選抜）の歴代結果・優勝〜ベスト4を年度別・種目別にまとめた入口ページです。"
        url={pageUrl}
        type="article"
      />
      ...
      <PageLayout maxWidth="4xl">
        ...
        <div className="mb-8 space-y-3 text-sm text-text-secondary">
          ...
          <p>
            ...
            このページでは大会そのものを軸に、その年の頂点に立った学校・ペア・選手を横断的に確認できます。
          </p>
        </div>
