            ...
            <main className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 py-10 px-4">
                <div className="max-w-4xl mx-auto">
                    <Breadcrumbs
                        crumbs={[
                            { label: 'ホーム', href: '/' },
                            { label: `高校カテゴリ（${genderLabel}）`, href: `/highschool/${gender}` },
                        ]}
                    />

                    <h1 className="text-2xl font-bold mb-6">高校カテゴリ（{genderLabel}）</h1>
                    ...
                    <div className="mb-8">
                        <div className="flex gap-4 justify-center">
                            <Link
                                ...
                                className={`px-8 py-4 rounded-lg border-2 transition block text-center ${gender === 'boys'
                            ...
                            <Link
                                ...
                                className={`px-8 py-4 rounded-lg border-2 transition block text-center ${gender === 'girls'
