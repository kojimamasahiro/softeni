...
export default function AnalysisPage({ year, matches, teams }: AnalysisPageProps) {
                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    <Breadcrumbs
                        crumbs={[
                            ...
                            { label: `${year} データ・分析`, href: `/st-league/${year}/analysis` },
                        ]}
                    />
                                    ...
                                    return (
                                        <tr key={player.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                            ...
                                            <td className="py-3 px-4 text-center">
                                                <span className="font-bold mr-1">{player.wins}-{player.losses}</span>
