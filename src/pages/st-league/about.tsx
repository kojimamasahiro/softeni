...
export default function STLeagueAbout() {
  ...
  return (
    <>
      <MetaHead title={pageTitle} description="ソフトテニス実業団最高峰リーグ「STリーグ」の概要、仕組み、観戦の見どころについて解説します。" url={pageUrl} />
      ...
      <PageLayout className="space-y-12">
        ...
        <section className="max-w-3xl mx-auto mb-10 px-4">
          ...
          <p className="text-lg leading-relaxed mb-4">企業チームとしての誇りと、選手個人のプライドがぶつかり合う熱い戦いの舞台です。</p>
        </section>
        ...
        <section className="bg-surface p-8 rounded-2xl shadow-sm">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p>
              STリーグ（Soft Tennis League）は、男女とも実業団チームが参加する ソフトテニスのトップリーグ戦です。男女それぞれの実業団トップチームが集い、
        ...
        <section className="bg-surface p-8 rounded-2xl shadow-sm">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <div className="mt-6 bg-white dark:bg-gray-700/50 rounded-xl p-6">
              <h3 className="text-lg font-bold mb-3 text-center">標準的なオーダー順</h3>
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center">
                <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm w-full md:w-32 border border-blue-100 dark:border-gray-600">
                  <span className="block text-xs text-gray-500 mb-1">第1試合</span>
                  <strong className="text-blue-600 font-bold">ダブルス</strong>
                </div>
                <div className="text-gray-400">→</div>
                <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm w-full md:w-32 border border-blue-100 dark:border-gray-600">
                  <span className="block text-xs text-gray-500 mb-1">第2試合</span>
                  <strong className="text-indigo-600 font-bold">シングルス</strong>
                </div>
                <div className="text-gray-400">→</div>
                <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm w-full md:w-32 border border-blue-100 dark:border-gray-600">
                  <span className="block text-xs text-gray-500 mb-1">第3試合</span>
                  <strong className="text-blue-600 font-bold">ダブルス</strong>
                </div>
              </div>
              <p className="text-sm text-gray-500 mt-4 text-center">※ 大会規定により変更となる場合があります。</p>
            </div>
          </div>
        </section>
