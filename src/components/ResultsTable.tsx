        ...
        {rows.map((match, i) => {
          ...
          return (
            <tr key={i} className="text-center">
              <td className="border-b border-gray-200 dark:border-gray-700 px-2 py-1">{round}</td>
              <td className="border-b border-gray-200 dark:border-gray-700 px-2 py-1">{opponentDisplay}</td>
              <td className="border-b border-gray-200 dark:border-gray-700 px-2 py-1">{scoreDisplay}</td>
            </tr>
          );
        })}
      </tbody>
