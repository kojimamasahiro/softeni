...
> **2026-09-23 に団体戦のオーダーの節を [team-match-order-import.md](./team-match-order-import.md) へ分けた**
> （分ける前の全文は [raw/2026-09-23-wiki-archive-data-import.md](../raw/2026-09-23-wiki-archive-data-import.md)）。
...
仕様は [data-model.md](./data-model.md) と [ADR-020](../adr/ADR-020-team-match-rubber-details.md)、手順はスキル `team-match-order`。
**様式ごとの読み方・検算・出典の誤記の扱いは [team-match-order-import.md](./team-match-order-import.md)**（2026-09-23 に分けた）。
...
- [team-match-order-import.md](./team-match-order-import.md) — 団体戦のオーダーの取り込み
