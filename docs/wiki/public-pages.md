...
| ユーザーの課題を体系的に見つける | **発散フェーズ・未着手**（2026-09-06）。ユーザー側の信号（サイト内検索語など）から使いにくさを探す。GA4 のイベント保持期限（既定2ヶ月）が切れる前に検索語を読む | [アイデア](../raw/2026-09-06-idea-user-problem-discovery.md) |
