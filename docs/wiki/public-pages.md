...
| 日本体育大学の独自ページ（`/teams/nssu/`）と大学カテゴリの関係 | **実装済み**（2026-09-14）。`/teams/nssu/` は残し、大学37校を同じ `/teams/[teamId]` 型で追加。大学カテゴリと相互リンク（[university.md](./university.md)） | [アイデア](../raw/2026-09-13-idea-nssu-team-page-and-university.md) |
...
| 大学カテゴリの公開ページ | **実装済み**（2026-09-13）。`/university/` と大学別の出身高校、高校ページの「進路」節。仕様は [university.md](./university.md) | [アイデア](../raw/2026-08-12-idea-university-category-pages.md) / [チーム名の下ごしらえ](../raw/2026-08-12-university-team-name-cleanup.md) |
| 成年（社会人・一般）カテゴリの都道府県ページ・強豪チームランキング | **発散フェーズ**（2026-08-11）。高校型のフル横展開はデータ不足で非推奨。上位チームに絞った一覧は未検討。STリーグのメンバー節のみ実装（[st-league.md](./st-league.md)） | [アイデア](../raw/2026-08-11-idea-general-category-prefecture-pages.md) |
