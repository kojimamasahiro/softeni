...
> **2026-09-14 更新**: グループ名「特集」は「**カテゴリから探す**」に変更した（小学生・中学生・高校生・大学生・STリーグ）。
> 小〜大が揃い、一部を切り出した特集ではなく分類として読めるようになったため。上表と §3 のツリーは承認時（D-010）の記録として残す。
> 経緯: `lib/navigation.ts` のコメント、[docs/wiki/public-pages.md](../../wiki/public-pages.md)
