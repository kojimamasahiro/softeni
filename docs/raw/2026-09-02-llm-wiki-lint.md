...
| 項目 | 結果 |
|---|---|
| リンク切れ | **0件**（検出3件はすべて `docs/raw/2026-06-12-adsense-ui-proposal.md` の見出しで、角括弧のパス表記の直後に丸括弧の説明が来る型の誤検知） |
...
`docs/raw/2026-08-10-exploration-cycle-audit.md` §1-7 の提言（全ての中断案件に再開条件を統一
