# wiki アーカイブ: data-import.md（2026-09-23 圧縮前の全文）

2026-09-23 に [docs/wiki/data-import.md](../wiki/data-import.md) が1ページの目安（12,000字）を超えたため、
...
> **2026-09-18 に現在の仕様だけへ圧縮し、PDF の読み取りは [pdf-import.md](../wiki/pdf-import.md) へ分けた。**
...
PDF から読み取る部分は [pdf-import.md](../wiki/pdf-import.md)。

## prebuild のゲート

`npm run prebuild` が健全性チェック → 正準化 → 生成を直列に実行する（全段の並びは [deployment.md](../wiki/deployment.md) が正）。
...
仕様は [data-model.md](../wiki/data-model.md) と [ADR-020](../adr/ADR-020-team-match-rubber-details.md)、
手順はスキル `team-match-order`。読み取りは [pdf-import.md](../wiki/pdf-import.md)。
...
[upcoming-tournaments-runbook.md](../wiki/upcoming-tournaments-runbook.md) S11。読み方の要点:
...
詳細は [team-player-identity.md](../wiki/team-player-identity.md) / [player-name-identity.md](../wiki/player-name-identity.md)。
取り込み側で守ること:
...
- **`entriesMeta` の選手を `participants` にも登録する**。これが無いと**シード・足長が `participants` から丸ごと消え**、
  出場者集合に依存するプレビューの4ブロックが同時に沈黙する（[news-context-blocks.md](../wiki/news-context-blocks.md) ⑥）。
...
（[tournaments-local.md](../wiki/tournaments-local.md) / [ADR-001](../adr/ADR-001-local-source-detection-store.md)）。
...
- [pdf-import.md](../wiki/pdf-import.md) — PDF の読み取りと検算
- [data-model.md](../wiki/data-model.md) — データの形 / [deployment.md](../wiki/deployment.md) — prebuild の全段
- [team-player-identity.md](../wiki/team-player-identity.md) / [player-name-identity.md](../wiki/player-name-identity.md) — 名寄せ
- [tournaments-local.md](../wiki/tournaments-local.md) — 地方大会の掲載運用
